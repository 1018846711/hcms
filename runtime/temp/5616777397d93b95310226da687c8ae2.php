<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"E:\hcms\\theme\admin\department\index.html";i:1529482498;}*/ ?>
<body>
<style type="text/css">
    a {
        font-size: 18px;
...
<div style="float: left;margin: 10px 10px;width: 400px">
    <ul id="nav" style="overflow:scroll;overflow-x:hidden;height: 80%;">
        <li class="top-department" data-id="0">
            ...
            <?php echo $department_str; ?>
        </li>
    </ul>
    <?php if(request()->controller() == 'Administrator'): ?>
    <a class="layui-btn layui-btn-normal" style="float: right;margin-right: 10px;margin-top: 20px">确定提交</a>
    <?php endif; ?>
</div>
<?php if(request()->controller() == 'Department'): ?>
    ...
    $(function () {
        layui.use('form', function () {
            ...
            form.on('submit(sureBtn)', function (data) {
                ...
                if (type == "add") {
                    field.pid = field.id;
                    var url = "http://www.hcms.com/admin/department/insert.html";
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: field,
                    ...
                    var url = "http://www.hcms.com/admin/department/update.html";
                    $.ajax({
                        type: "POST",
                        url: url,
                        data: field,
        ...
        $(document).on("click", ".icon-delete", function () {
            ...
            var url = "http://www.hcms.com/admin/department/delete.html";
